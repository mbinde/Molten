...
struct CatalogViewTests {
    ...
    private func createTestCatalogItems() -> [CatalogItemModel] {
        return [
            ...
            CatalogItemModel(name: "Bullseye Yellow", rawCode: "BULLSEYE-YLW-004", manufacturer: "Bullseye Glass"),
            CatalogItemModel(name: "Spectrum Clear", rawCode: "SPECTRUM-CLR-005", manufacturer: "Spectrum Glass")
        ]
    }
    ...
    func testCatalogViewRepositoryDataLoading() async throws {
        ...
        #expect(codes.contains("BULLSEYE-RGR-001"), "Should contain Bullseye Red item")
        #expect(codes.contains("SPECTRUM-BGS-002"), "Should contain Spectrum Blue item")
