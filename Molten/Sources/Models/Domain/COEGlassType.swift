...
class COEGlassPreference {
    ...
    nonisolated static let storageKey = "selectedCoeGlassFilter"

    /// Storage key for multi-selection (new)
    nonisolated static let multiSelectionStorageKey = "selectedCoeGlassTypes"
    ...
    nonisolated static var current: COEGlassType? {
    ...
    nonisolated static func setCOEFilter(_ coeType: COEGlassType?) {
    ...
    nonisolated static func addCOEType(_ coeType: COEGlassType) {
    ...
    nonisolated static func removeCOEType(_ coeType: COEGlassType) {
        var current = selectedCOETypes
    ...
    nonisolated static func setSelectedCOETypes(_ coeTypes: Set<COEGlassType>) {
        saveSelectedCOETypes(coeTypes)
    }

    /// Save selected COE types to UserDefaults
    nonisolated private static func saveSelectedCOETypes(_ coeTypes: Set<COEGlassType>) {
