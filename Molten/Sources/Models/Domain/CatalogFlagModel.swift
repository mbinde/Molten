...
enum GlassFlagKey: String, Codable, CaseIterable, Sendable {
    ...
    /// Review-mode display name with priority prefixes (AAA, BBB, etc.)
    /// Used in catalog review UI to prioritize flag review order
    nonisolated var displayNameReview: String {
        switch self {
        ...
        case .containsSilver: return "BBB Contains silver ('Raku')"
        case .containsCopper: return "Contains copper"
        case .containsLead: return "Contains lead"
        case .containsSulfur: return "Contains sulfur"
        case .containsGold: return "Contains gold"
        ...
        case .metallicShimmer: return "BBB Metallic shimmer"
        ...
        case .workCool: return "Work cool"
        case .multi: return "__multi__ (multiple distinct colors)"
