...
enum GlassFlagKey: String, Codable, CaseIterable, Sendable {
    ...
    nonisolated var displayName: String {
        ...
        case .colorMaturesInKiln: return "Color develops in kiln"
        ...
        case .devitrifies: return "Devitrifies easily"
        case .sensitiveToCoolingRate: return "Sensitive to cooling rate"
        case .containsSilver: return "Contains silver ('Raku')"
        ...
        case .containsGold: return "Needs fusing gold hold (2 hours @ 1225F/663C)"
        ...
        case .goodStringers: return "Thins well (Good for stringers/blowing)"
        ...
        case .thinsWhenStretched: return "Dillutes when stretched"
        case .containsSparkles: return "Contains sparkles/aventurine"
        case .containsDichro: return "Contains dichroic"
        case .includesMicroBubbles: return "Seeded (micro-bubbles)"
        ...
        case .discontinued: return "Discontinued/Limited/Experimental"
