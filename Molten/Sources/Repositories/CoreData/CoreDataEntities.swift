...
// NOTE: CoatingItem, GlassItem, ItemTags, ToolItem are auto-generated by Xcode
// because they use codeGenerationType="class" in the Core Data model.
// They will be deleted soon, so no manual declarations here.

// Item must stay for now because UserItem extends it (UserItem will also be deleted)
