...
/// Handles location-based inventory storage tracking (e.g., "Shelf A", "Box 3")
nonisolated protocol LocationRepository: Sendable {
    ...
    /// - Parameter location: The StorageLocationModel to create
    /// - Returns: The created StorageLocationModel
    ...
    /// - Parameter location: The StorageLocationModel with updated values
    /// - Returns: The updated StorageLocationModel
    func updateLocation(_ location: StorageLocationModel) async throws -> StorageLocationModel

    /// Delete a location record
    /// - Parameter location: The StorageLocationModel to delete
    ...
    ///   - inventory_id: The UUID of the inventory record
    /// - Returns: The updated or created StorageLocationModel
    ...
    ///   - locationName: The location name
    ///   - inventory_id: The UUID of the inventory record
    /// - Returns: The updated StorageLocationModel, or nil if record was deleted due to zero quantity
...
// Note: StorageLocationModel is defined in SharedModels.swift
