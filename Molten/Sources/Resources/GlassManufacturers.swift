...
struct GlassManufacturers {
    ...
    /// Controls whether descriptions are shown for each manufacturer.
    /// All descriptions in the catalog are now our original synthesized content,
    /// so we can show them for all manufacturers.
    ...
    nonisolated static func colorForManufacturer(_ manufacturer: String?) -> Color {
        ...
        case "lunar glass", "lun":
            return Color(red: 0.7, green: 0.7, blue: 0.9)  // Pale lavender/moon color
