//
//  InventoryFilterSheet.swift
//  Molten
//
//  Filter sheet for Inventory view, accessible from the floating filter button
//
...
struct InventoryFilterSheet: View {
                ...
                if !availableLocations.isEmpty {
                    Section("Location") {
                        ForEach(availableLocations, id: \.self) { location in
                            ...
                            let displayName = location == LocationQuickFilterBar.noLocationValue ? "No Location" : location
                            Button {
    ...
    private var hasActiveFilters: Bool {
        ...
        !selectedManufacturers.isEmpty || !selectedLocations.isEmpty ||
...
// MARK: - Product Type Chip (shared with Catalog)
