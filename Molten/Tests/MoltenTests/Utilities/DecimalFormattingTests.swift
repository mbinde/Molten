...
struct DecimalFormattingTests {
    ...
    func testFormatZeroDecimalPlaces() {
        ...
        let formatted = value.formattedString(decimalPlaces: 0) as String
    ...
    func testFormatWithOneDecimalPlace() {
        let value = Decimal(string: "3.456")!
        let formatted = value.formattedString(decimalPlaces: 1) as String
    ...
    func testFormatThreeDecimalPlaces() {
        ...
        let formatted = value.formattedString(decimalPlaces: 3) as String
    ...
    func testFormatTwoDecimalPlacesExact() {
        ...
        let formatted = value.formattedString(decimalPlaces: 2) as String
    ...
    func testFormatFourDecimalPlaces() {
        ...
        let formatted = value.formattedString(decimalPlaces: 4) as String
