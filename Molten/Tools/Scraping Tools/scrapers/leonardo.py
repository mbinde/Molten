"""
Leonardo Lampwork scraper

Scrapes tool products from Leonardo Lampwork website (Shopify-based)
"""
...
# Constants
MANUFACTURER_CODE = 'leonardo'
MANUFACTURER_NAME = 'Leonardo Lampwork'
MANUFACTURER_URL = 'https://leonardolampwork.com'
PRODUCT_TYPE = 'tools'


def scrape(test_mode=False, max_items=None):
    """
    Scrape tool products from Leonardo Lampwork using Shopify JSON API
