//
//  ItemMinimum+CoreDataProperties.swift
//  
//
...
public typealias ItemMinimumCoreDataPropertiesSet = NSSet

extension ItemMinimum {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<ItemMinimum> {
        return NSFetchRequest<ItemMinimum>(entityName: "ItemMinimum")
    }
...
extension ItemMinimum : Identifiable {
